...
import se.celekt.gem_app.jade.handlers.IEventHandler;
...
public class EventsMgr {
	 ...
	 */
	private static EventsMgr theInstance = new EventsMgr();
	/**
	 ...
	 */
	private Logger myLogger = Logger.getMyLogger(EventsMgr.class.getName()); 
	 ...
	 */
	public Events createEvent(String eventName){
		return new Events(eventName);
	}
	...
	public synchronized void registerEvent(String eventName, IEventHandler updater){
        ...
        LogSaver.getInstance().writeLog(LogSaver.REGISTER_EVENT, LogSaver.MessageType.INFO,"The " + eventName + " was registered");
	}
	 ...
	 */
	public synchronized void fireEvent(Events event){
	 ...
	 */
	public  void fireEventDelayed(Events event, long delayMillis) {
		String eventName = event.getName();
