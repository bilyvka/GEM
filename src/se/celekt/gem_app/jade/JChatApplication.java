...
/**
 * This class is accessible directly by all activities and it is used to get stored preferences
...
public class JChatApplication extends Application {
	...
	private void initializeParameters(){
		//Sets the properties to connect to the JADE platform. the AMS
		SharedPreferences prefs = getSharedPreferences(SHARED_PREFERENCES_NAME, MODE_PRIVATE);
		SharedPreferences.Editor prefEditor = prefs.edit();
		
		//IP of the host where the AMS is located
		...
		//Port that the AMS is listening. Normally, 1099
		...
		//The location provider we will use to get the location. Let's use GPS
		...
		//Name of the device. If not written, it will be randomly generated
...
//			}
			...
			prefEditor.putString(PREFERENCE_PHONE_NUMBER, "default");
		}
		prefEditor.commit();
	}
