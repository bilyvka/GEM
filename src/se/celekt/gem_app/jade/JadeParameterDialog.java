...
public class JadeParameterDialog extends Dialog {
	...
	private void fillWithDefaults(){
		...
		providerSpinner.setSelection((locationProvider.equals(LocationManager.GPS_PROVIDER)? 0: 2));
	...
	private View initUI(){
		...
		jadePort.setText("Jade platform port. Default: 1099");
		...
		phoneNbr.setText("Device Identificator");
		params = new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);
		...
		locProviderName.setText("Location Provider. Default: gps");
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(activity,android.R.layout.simple_spinner_item,new String[]{LocationManager.GPS_PROVIDER, LocationManager.NETWORK_PROVIDER,"simulator"});
		...
		scrollingView.setLayoutParams(new FrameLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
