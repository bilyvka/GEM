...
/**
 * This class contains data related to a single LocationMessage message
 * 
 * @author Didac Gil
 * @version 1.0
 */
...
public class LocationMessage {
	 ...
	 */
	public LocationMessage(String message, String senderName, String senderTel){
	 ...
	 */
	public LocationMessage(ACLMessage msg){
	 ...
	 */
	public LocationMessage(LocationMessage message){
	 ...
	 */
	public LocationMessage(String message, String senderName, String senderTel, long timestamp){
		time = timestamp;
	...
	public boolean equals(Object o) {
		...
		LocationMessage msg = (LocationMessage) o;
	...
	/**
	 * Gets the Latitude value from the ContentMessage
	 * 
	 * @return float with the latitude value
	 */
	...
	/**
	 * Gets the Longitude value from the ContentMessage
	 * 
	 * @return float with the longitude value
	 */
	...
	/**
	 * Gets the Altitude value from the ContentMessage
	 * 
	 * @return float with the altitude value
	 */
